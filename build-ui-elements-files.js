...
(async function build() {
  ...
  await fs.copy('./projects/ui-elements/src/assets', './dist/ui-elements/assets', err => {
    if (err) return console.error(err)
  });

  await fs.copy('./projects/ui-elements/package.json', './dist/ui-elements/package.json', err => {
    if (err) return console.error(err)
  });
